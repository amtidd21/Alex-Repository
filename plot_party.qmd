...
grid_100 = expand.grid(k = seq(0, 100, length.out = 10), home_ice = seq(0, 100, length.out = 10), d = seq(0, 100, length.out = 10))
...
ggplot(data = residual_100_df, aes(x = k,
                               y = home_ice)) +
   geom_tile(aes(fill = mean_residual)) +
  geom_point(aes(x = 38.33333, y = 53.33333), color = "black", fill = "black") +
  scale_fill_viridis_c(option = "D", 
                       limits = c(0.36, 0.41), 
                       oob = scales::squish, 
                       name = "Mean residual",
...
apr_15_ranking[[110]] |> arrange(rating)
```
