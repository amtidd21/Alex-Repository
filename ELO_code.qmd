...
new_home_rating <- hockey_new_ratingh(team_rating = home_rating, observed_score = observed_home_score, expected_score = hockey_exp_scores(home_rating, away_rating))
