...
```{r}
k = 20
elo_ratings_initial <- elo_ratings_initial |> 
...
```{r}
ratings_update_home <- tibble(team = elo_ratings_initial$home_team,
                              rating = elo_ratings_initial$elo_new_home)
ratings_updated_away <- tibble(team = elo_ratings_initial$away_team,
                              rating = elo_ratings_initial$elo_new_away)
```
