...
schedule_Bentley <- schedule |> filter(away_team == "Bentley" | home_team == "Bentley")
...
dates_vec <- unique(schedule_Bentley$date)
...
for (i in dates_vec) {
  new_rankings <- update_rankings(season = schedule_Bentley, game_date = i, ratings = new_rankings, k = 100)
...
try_1_Bentley = update_rankings_iter(season = schedule_Bentley, end_date = "2024-03-23", ratings = rankings, k = 100)
