...
k = seq(45, 55, length.out = 10)
home_ice = seq(60, 70, length.out = 10)
d = seq(45, 55, length.out = 10)

grid = expand.grid(k = seq(45, 55, length.out = 10), home_ice = seq(60, 70, length.out = 10), d = seq(45, 55, length.out = 10))
...
```{r}
apr_5_ranking = update_rankings_iter_gd_ha(schedule, "2025-04-05", rankings2324, 51, 64, 0.3515844)
```
